...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SATQuestion.answer_E'
        db.alter_column('mchlrn_satquestion', 'answer_E', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'SATQuestion.answer_D'
        db.alter_column('mchlrn_satquestion', 'answer_D', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'SATQuestion.answer_C'
        db.alter_column('mchlrn_satquestion', 'answer_C', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'SATQuestion.answer_B'
        db.alter_column('mchlrn_satquestion', 'answer_B', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'SATQuestion.answer_A'
        db.alter_column('mchlrn_satquestion', 'answer_A', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'SATQuestion.answer_E'
        db.alter_column('mchlrn_satquestion', 'answer_E', self.gf('django.db.models.fields.CharField')(default=None, max_length=256))

        # Changing field 'SATQuestion.answer_D'
        db.alter_column('mchlrn_satquestion', 'answer_D', self.gf('django.db.models.fields.CharField')(default=None, max_length=256))

        # Changing field 'SATQuestion.answer_C'
        db.alter_column('mchlrn_satquestion', 'answer_C', self.gf('django.db.models.fields.CharField')(default=None, max_length=256))

        # Changing field 'SATQuestion.answer_B'
        db.alter_column('mchlrn_satquestion', 'answer_B', self.gf('django.db.models.fields.CharField')(default=None, max_length=256))

        # Changing field 'SATQuestion.answer_A'
        db.alter_column('mchlrn_satquestion', 'answer_A', self.gf('django.db.models.fields.CharField')(default=None, max_length=256))
