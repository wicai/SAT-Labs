...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sat_Q_Processed.avg_score'
        db.add_column(u'mchlrn_sat_q_processed', 'avg_score',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sat_Q_Processed.avg_score'
        db.delete_column(u'mchlrn_sat_q_processed', 'avg_score')
