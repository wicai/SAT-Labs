...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Answered_Sat_Q.user'
        db.alter_column(u'mchlrn_answered_sat_q', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mchlrn.User']))

        # Changing field 'Answered_Math_Q.user'
        db.alter_column(u'mchlrn_answered_math_q', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mchlrn.User']))
